...
This is more of a utility class to help with Firecrawl API calls.

Separate layer needs to be built on top of this to handle LLM tool calling. - more streamlined to what LLM expects
"""
